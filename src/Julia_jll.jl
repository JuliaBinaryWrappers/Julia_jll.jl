...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Julia_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("244e23d5-fc54-5d73-9c72-02c970f46b1e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Julia", artifacts_toml) for e in artifacts["Julia"]]
...
if best_platform === nothing
    @debug("Unable to load Julia; unsupported platform $(triplet(platform_key_abi()))")
else
