# Autogenerated wrapper script for Julia_jll for x86_64-w64-mingw32-libgfortran4-cxx11
export julia, libjulia
...
const julia_splitpath = ["bin", "julia.exe"]
...
const libjulia_splitpath = ["bin", "libjulia.dll"]
